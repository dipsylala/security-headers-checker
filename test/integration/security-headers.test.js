...
const HEADER_TEST_SITES = [
    ...
    },
    {
        ...
        expectedResults: {
            shouldHaveHSTS: false, // Mozilla Developer site doesn't have HSTS
            shouldHaveMinimumHeaders: 3,
            criticalHeadersExpected: 0, // No critical headers expected
            importantHeadersExpected: 2
        }
    },
    {
        ...
        expectedResults: {
            shouldHaveHSTS: false, // Google.com doesn't have HSTS on main page
            shouldHaveMinimumHeaders: 3,
            criticalHeadersExpected: 0, // No critical headers expected
            importantHeadersExpected: 2
        }
