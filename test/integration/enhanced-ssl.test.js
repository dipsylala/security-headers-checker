 ...
 * Tests the comprehensive SSL/TLS analysis functionality including protocols, ciphers, and vulnerabilities
 */
...
async function testGitHubComprehensiveSSL() {
    ...
    try {
        ...
        if (result.statusCode === 200 && result.body.details && result.body.details.detailedSsl) {
            ...
            console.log(`🎯 Comprehensive SSL Grade: ${analysis.grade || 'N/A'}`);
            console.log(`📈 Comprehensive SSL Score: ${analysis.score || 'N/A'}/100`);
...
async function testHTTPSiteComprehensiveSSL() {
    ...
    try {
        ...
        if (result.statusCode === 200 && result.body.details && result.body.details.detailedSsl) {
            ...
            if (!analysis.supported && analysis.error === 'HTTPS not used') {
...
async function testMainEndpointComprehensiveSSL() {
    ...
    try {
        ...
        if (result.statusCode === 200 && result.body.details?.detailedSsl) {
            ...
            console.log(`🎯 Comprehensive SSL in main endpoint: ${detailedSsl.supported ? 'Present' : 'Missing'}`);
            console.log(`📈 Comprehensive SSL Grade: ${detailedSsl.grade || 'N/A'}`);
